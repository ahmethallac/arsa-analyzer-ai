      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input 
            id="parcel" 
            value={value.parcel} 
            onChange={e => onChange({ ...value, parcel: e.target.value })} 
            placeholder="Örn: 56" 
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input 
            id="sqm" 
            value={value.sqm || ''} 
            onChange={e => onChange({ ...value, sqm: e.target.value })} 
          ...
          >
            ...
            <SelectContent>
              {imarDurumlari.map(imar => (
                <SelectItem key={imar} value={imar}>
                  {imar}
                </SelectItem>
              ))}
            </SelectContent>
          ...
          >
            ...
            <SelectContent>
              {tapuDurumlari.map(tapu => (
                <SelectItem key={tapu} value={tapu}>
                  {tapu}
                </SelectItem>
              ))}
            </SelectContent>
